...
public class GeneratedIntermediaryExchange implements ProductUsage, WasteTreatmentUsage
{
    ...
    public GeneratedIntermediaryExchange(TemplateProductUsage template, Map<String, String> modelOutputs,
