...
public class EcospoldTemplateSubstanceUsages implements TemplateSubstanceUsages
{
    ...
    private static final TemplateSubstanceUsage[] toSoil = {
            new TemplateSubstanceUsage("Cadmium", SOIL_AGRICULTURAL, AvailableUnit.KG, "heavymetal_to_soil_cd",
                                       StandardUncertaintyMetadata.HM_TO_SOIL, ""),
            new TemplateSubstanceUsage("Chromium", SOIL_AGRICULTURAL, AvailableUnit.KG, "heavymetal_to_soil_cr",
                                       StandardUncertaintyMetadata.HM_TO_SOIL, ""),
            new TemplateSubstanceUsage("Copper", SOIL_AGRICULTURAL, AvailableUnit.KG, "heavymetal_to_soil_cu",
                                       StandardUncertaintyMetadata.HM_TO_SOIL, ""),
            new TemplateSubstanceUsage("Lead", SOIL_AGRICULTURAL, AvailableUnit.KG, "heavymetal_to_soil_pb",
                                       StandardUncertaintyMetadata.HM_TO_SOIL, ""),
            new TemplateSubstanceUsage("Mercury", SOIL_AGRICULTURAL, AvailableUnit.KG, "heavymetal_to_soil_hg",
                                       StandardUncertaintyMetadata.HM_TO_SOIL, ""),
            new TemplateSubstanceUsage("Nickel", SOIL_AGRICULTURAL, AvailableUnit.KG, "heavymetal_to_soil_ni",
                                       StandardUncertaintyMetadata.HM_TO_SOIL, ""),
            new TemplateSubstanceUsage("Zinc", SOIL_AGRICULTURAL, AvailableUnit.KG, "heavymetal_to_soil_zn",
                                       StandardUncertaintyMetadata.HM_TO_SOIL, ""),
