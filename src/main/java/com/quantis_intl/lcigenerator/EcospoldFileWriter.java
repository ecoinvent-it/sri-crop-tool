...
public class EcospoldFileWriter
{
            ...
            throws IOException
    {
        ...
        //md.setActivityName(ImmutableList.of(TValidActivityName.ofEn(activity.getId(), activityName)));
        activity.setActivityNameId(
                UUIDType5.nameUUIDFromNamespaceAndString(UUIDType5.NAMESPACE_DNS, activityName));
