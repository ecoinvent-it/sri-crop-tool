...
{
    License getExistingLicenseById(Qid licenseId);

    // Get the first still active non depleted license, or null if none are found
    License getCurrentActiveLicenseForUser(Qid userId);
    ...
    public static class LicenseNotFound extends RuntimeException
    {
        private static final long serialVersionUID = 4387803553540224239L;

        public LicenseNotFound(Qid id)
        {
            super(id.toString());
        }
    }
