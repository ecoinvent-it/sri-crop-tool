...
public interface SubstanceUsage
{
    ...
    default String getSubCompartment()
    {
        return "";
    }
    ...
    default String[] asArray()
    {
        ...
        return new String[] { getName(), getSubCompartment(), getUnit(), getAmount(), UncertaintyArray[0],
                UncertaintyArray[1], UncertaintyArray[2], UncertaintyArray[3], getComment() };
    }
}
