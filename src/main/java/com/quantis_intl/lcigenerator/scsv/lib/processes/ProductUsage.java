...
public interface ProductUsage
{
    ...
    default String[] asArray()
    {
        ...
        return new String[] { getName(), getUnit(), getAmount(), uncertaintyArray[0], uncertaintyArray[1],
                uncertaintyArray[2], uncertaintyArray[3], getComment() };
    }
}
