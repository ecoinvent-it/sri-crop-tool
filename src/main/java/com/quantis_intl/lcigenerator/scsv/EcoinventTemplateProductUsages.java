...
public class EcoinventTemplateProductUsages implements TemplateProductUsages
{
    ...
    private static final TemplateProductUsage[] materialsFuels = {
            ...
            new TemplateProductUsage("Diesel, burned in building machine/GLO U", "MJ",
                    "seeds_banana",
                    StandardUncertaintyMetadata.SEEDS, "nb_planted_trees", 0.45 * 42.8),
            new GroupedTemplateProductUsage("p", "seeds_bellpepper",
                                            StandardUncertaintyMetadata.SEEDS, "nb_seedlings", "country", SEEDLINGS_CH,
                                            SEEDLINGS_MAP),
            new GroupedTemplateProductUsage("p", "seeds_cabbage",
                                            StandardUncertaintyMetadata.SEEDS, "nb_seedlings", "country", SEEDLINGS_CH,
                                            SEEDLINGS_MAP),
            ...
            new TemplateProductUsage("Diesel, burned in building machine/GLO U", "MJ",
                                     "seeds_cashew",
                                     StandardUncertaintyMetadata.SEEDS, "nb_planted_trees", 0.45 * 42.8),
            new TemplateProductUsage("Potato seed IP, at regional storehouse/CH U", "kg", "seeds_cassava",
                                     StandardUncertaintyMetadata.SEEDS, "seeds"),
            new GroupedTemplateProductUsage("p", "seeds_chilli",
                                            StandardUncertaintyMetadata.SEEDS, "nb_seedlings", "country", SEEDLINGS_CH,
                                            SEEDLINGS_MAP),
            ...
            new TemplateProductUsage("Diesel, burned in building machine/GLO U", "MJ",
                    "seeds_coffee",
                    StandardUncertaintyMetadata.SEEDS, "nb_planted_trees", 0.45 * 42.8),
            new TemplateProductUsage("Grass seed IP, at regional storehouse/CH U", "kg", "seeds_cotton",
                                     StandardUncertaintyMetadata.SEEDS, "seeds"),
            new GroupedTemplateProductUsage("p", "seeds_eggplant",
                                            StandardUncertaintyMetadata.SEEDS, "nb_seedlings", "country", SEEDLINGS_CH,
                                            SEEDLINGS_MAP),
            new TemplateProductUsage("Grass seed IP, at regional storehouse/CH U", "kg", "seeds_flax",
                                     StandardUncertaintyMetadata.SEEDS, "seeds"),
            new TemplateProductUsage("Diesel, burned in building machine/GLO U", "MJ",
                                     "seeds_grape",
                                     StandardUncertaintyMetadata.SEEDS, "nb_planted_trees", 0.45 * 42.8),
            new TemplateProductUsage("Pea seed IP, at regional storehouse/CH U", "kg", "seeds_guar",
                                     StandardUncertaintyMetadata.SEEDS, "seeds"),
            new TemplateProductUsage("Grass seed IP, at regional storehouse/CH U", "kg", "seeds_hemp",
                                     StandardUncertaintyMetadata.SEEDS, "seeds"),
            new TemplateProductUsage("Diesel, burned in building machine/GLO U", "MJ",
                    "seeds_lemonlime",
                    StandardUncertaintyMetadata.SEEDS, "nb_planted_trees", 0.45 * 42.8),
            new TemplateProductUsage("Pea seed IP, at regional storehouse/CH U", "kg", "seeds_lentil",
                                     StandardUncertaintyMetadata.SEEDS, "seeds"),
