...
public class GlobalTemplateSubstanceUsages implements TemplateSubstanceUsages
{
    ...
    private static final TemplateSubstanceUsage[] resources = {
            ...
            new TemplateSubstanceUsage("Water, well, in ground, {country}", SubCompartment.RAW_IN_WATER,
                                       "m3", "wateruse_ground", StandardUncertaintyMetadata.IRRIGATION_WATER,
                                       "{wateruse_ground}"),
            new TemplateSubstanceUsage("Water, river, {country}", SubCompartment.RAW_IN_WATER,
                                       "m3", "wateruse_surface", StandardUncertaintyMetadata.IRRIGATION_WATER,
                                       "{wateruse_surface}"),
    ...
    private static final TemplateSubstanceUsage[] toAir = {
            new TemplateSubstanceUsage("Ammonia", SubCompartment.AIR_LOW_POP, "kg", "ammonia_total",
                                       ...
                                       "Calculated value - EMEP/EEA (2016)"),
            new TemplateSubstanceUsage("Carbon dioxide, fossil", SubCompartment.AIR_LOW_POP, "kg",
                                       ...
                                       "Calculated value - Emissions from urea or lime application - IPCC (2006)"),
            ...
            new TemplateSubstanceUsage("Dinitrogen monoxide", SubCompartment.AIR_LOW_POP, "kg", "N2o_air",
                                       StandardUncertaintyMetadata.N2O_NOX_TO_AIR, "Calculated value - IPCC (2006)"),
            ...
            new TemplateSubstanceUsage("Water, {country}", SubCompartment.AIR_LOW_POP, "ton", "wfldb_water_to_air",
                                       StandardUncertaintyMetadata.CH4_NH3_TO_AIR,
                                       "Calculated value - Emissions calculated from water balance")
    };
    ...
    private static final TemplateSubstanceUsage[] toWater = {
            new TemplateSubstanceUsage("Nitrate", SubCompartment.WATER_RIVER, "kg", "nitrate_to_surfacewater",
                                       StandardUncertaintyMetadata.NO3_PO4_TO_WATER, "Calculated value - SQCB-NO3"),
            ...
            new TemplateSubstanceUsage("Cadmium", SubCompartment.WATER_RIVER, "kg",
                                       ...
                                       "Calculated value - Freiermuth (2006)"),
            ...
            new TemplateSubstanceUsage("Lead", SubCompartment.WATER_RIVER, "kg", "heavymetal_to_surface_water_pb",
                                       StandardUncertaintyMetadata.HM_TO_WATER, "Calculated value - Freiermuth (2006)"),
            ...
            new TemplateSubstanceUsage("COD, Chemical Oxygen Demand", SubCompartment.WATER_GROUNDWATER, "kg",
                                       "cod_in_waste_water", StandardUncertaintyMetadata.COD_IN_WASTEWATER,
                                       "{cod_in_waste_water}"),
            new TemplateSubstanceUsage("DOC, Dissolved Organic Carbon", SubCompartment.WATER_GROUNDWATER, "kg",
                                       "doc_in_waste_water", StandardUncertaintyMetadata.COD_IN_WASTEWATER,
                                       "{cod_in_waste_water}"),
            new TemplateSubstanceUsage("TOC, Total Organic Carbon", SubCompartment.WATER_GROUNDWATER, "kg",
                                       "toc_in_waste_water", StandardUncertaintyMetadata.COD_IN_WASTEWATER,
                                       "{cod_in_waste_water}"),
            new TemplateSubstanceUsage("BOD5, Biological Oxygen Demand", SubCompartment.WATER_GROUNDWATER, "kg",
    ...
    private static final TemplateSubstanceUsage[] toSoil = {
            new TemplateSubstanceUsage("Cadmium", SubCompartment.SOIL_AGRICULTURAL, "kg", "heavymetal_to_soil_cd",
                                       StandardUncertaintyMetadata.HM_TO_SOIL, "Calculated value - Freiermuth (2006)"),
