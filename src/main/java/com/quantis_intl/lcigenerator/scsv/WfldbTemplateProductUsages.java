    ...
    private static final TemplateProductUsage[] materialsFuels = {
            ...
            new TemplateProductUsage(
                    "Transport, freight, lorry 16-32 metric ton, EURO5 {RER}| transport, freight, lorry 16-32 metric " +
                            "ton, EURO5 | Alloc Rec, U",
                    "tkm", "wfldb_transport_lorry_sup_16t", StandardUncertaintyMetadata.TRANSPORTS, ""),
            new TemplateProductUsage("Transport, freight, sea, transoceanic ship {GLO}| market for | Alloc Rec, U",
                                     "tkm", "wfldb_transport_transoceanic", StandardUncertaintyMetadata.TRANSPORTS, ""),
            new TemplateProductUsage("Transport, freight train {Europe without Switzerland}| market for | Alloc Rec, U",
                                     "tkm", "wfldb_transport_freight_rail_RER",
                    StandardUncertaintyMetadata.TRANSPORTS, ""),
            new TemplateProductUsage("Transport, freight train {US}| diesel | Alloc Rec, U", "tkm",
