...
MA_LIMEALGAE = MA_Ca + (MA_O + MA_H) * 2#Ca(OH)2
MA_MGSULFATE = MA_Mg + MA_S + MA_O * 4#MgSO4
...
Ca_TO_LIMEALGAE_FACTOR = MA_LIMEALGAE / MA_Ca
LIMESTONE_TO_CO2_FACTOR = MA_CO2 / MA_LIMESTONE
MG_TO_MGSULFATE_FACTOR = MA_MGSULFATE / MA_Mg
MG_TO_DOLOMITE_FACTOR = MA_DOLOMITE / MA_Mg
Zn_TO_ZINCSULFATE_FACTOR = MA_ZnO / MA_Zn
Zn_TO_ZINCOXIDE_FACTOR = 1.0  # FIXME
