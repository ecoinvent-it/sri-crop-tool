...
class DateUtils
{
  ...
  static DateFormat get dateTimeWriter =>
          _dateTimeWriter == null ?
  ...
  static DateFormat get dateWriter =>
          _dateWriter == null ?
  ...
  {
    return dateTime != null ? dateTimeWriter.format(parseDateTime(dateTime)) : "";
  }
  ...
  {
    return date != null ? dateWriter.format(parseDate(date)) : "";
  }
}